class KondutoOrder
  require File.expand_path('../konduto_address', __FILE__)
  require File.expand_path('../konduto_customer', __FILE__)
  require File.expand_path('../konduto_device', __FILE__)
  require File.expand_path('../konduto_navigation', __FILE__)
  require File.expand_path('../konduto_geolocation', __FILE__)
  require File.expand_path('../konduto_seller', __FILE__)
  require File.expand_path('../konduto_payment', __FILE__)
  require File.expand_path('../konduto_item', __FILE__)
  require File.expand_path('../konduto_travel', __FILE__)
  require File.expand_path('../konduto_utils', __FILE__)
  require 'json'
